...
var StyleButton = exports["default"] = /*#__PURE__*/function (_React$Component) {
  function StyleButton(props) {
    var _this;
    _classCallCheck(this, StyleButton);
    _this = _callSuper(this, StyleButton, [props]);
  ...
  return _createClass(StyleButton, [{
    key: "render",
    value: function render() {
      ...
      className += " md-RichEditor-styleButton-".concat(this.props.style.toLowerCase());
